...
export OUTPUT_DIR="outputs/sksmonstercalledlulu"
export CONFIG="./default_config.yaml"
export TRAIN_DATA="data/sksmonstercalledlulu/meta.jsonl"
...
CUDA_VISIBLE_DEVICES=1 accelerate launch --config_file $CONFIG train_lora_flux_pe.py \
    ...
    --validation_prompt "add a red sksmonstercalledlulu hugging the cat" \
