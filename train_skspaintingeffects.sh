...
export OUTPUT_DIR="outputs/skspaintingeffects"
export CONFIG="./default_config.yaml"
export TRAIN_DATA="data/skspaintingeffects/meta.jsonl"
...
CUDA_VISIBLE_DEVICES=1 accelerate launch --config_file $CONFIG train_lora_flux_pe.py \
    ...
    --validation_prompt "add a yellow flower on the cat's head and psychedelic colors and dynamic flows by skspaintingeffects" \
